        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Quienes Somos</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Miembros</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Proximos Proyectos</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Aliados</a>
